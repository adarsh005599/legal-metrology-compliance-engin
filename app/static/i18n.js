...
const TRANSLATIONS = {
  en: {
    ...
    assistantBotTitle: "MetraSetu Inspector Assistant",
    assistantBotSubtitle: "Comrade AI • Legal Metrology Q&A",
    assistantBotTooltip: "Ask Legal Metrology AI",
    assistantBotOpenTab: "Open in new window",
    assistantBotClose: "Close assistant",

    // Admin & Compliance Panel
    adminPageTitle: "MetraSetu — Admin & Statutory Compliance Panel",
    navAdminPanel: "Admin Compliance Panel",
    adminStatutoryNotice: "Enforcement records, violation escalation logs, and statutory legal configurations under the Legal Metrology Act, 2009.",
    adminHeaderTitle: "Statutory Enforcement & Compliance Manager",
    adminHeaderSubtitle: "Monitor raised statutory non-compliance violations, update governing Legal Metrology laws, and issue regulatory gazette circulars.",
    btnAddRule: "Add Statutory Rule",
    btnPublishCircular: "Publish Gazette Circular",
    adminKpiViolations: "Violations Raised",
    adminKpiViolationsHint: "Non-compliant & flagged packages",
    adminKpiPending: "Pending Action",
    adminKpiPendingHint: "Awaiting officer notice / escalation",
    adminKpiRules: "Active Statutory Rules",
    adminKpiRulesHint: "Configured legal metrology standards",
    tabViolationsTitle: "Raised Violations Registry",
    tabRulesTitle: "Statutory Rules & Laws Manager",
    tabAmendmentsTitle: "Gazette Circulars & Law Updates",
    searchViolationsPlaceholder: "Search by Scan ID, violation type, or rule...",
    filterAll: "All",
    filterPending: "Pending Review",
    filterDraftNotice: "Notice Drafted",
    filterEscalated: "Escalated to Officer",
    filterResolved: "Resolved / Compounded",
    colScanId: "Scan Ref ID",
    colTimestamp: "Timestamp",
    colViolation: "Statutory Violation Type",
    colSeverity: "Severity",
    colSection: "Governing Section",
    colActionStatus: "Enforcement Status",
    colActions: "Actions",
    loadingViolations: "Loading raised violations registry...",
    rulesManagerDesc: "Configure statutory legal standards, penalty brackets, and statutory rule descriptions evaluated during AI package screening.",
    amendmentsFeedTitle: "Official Gazette Amendments & Circulars Feed",
    amendmentsFeedDesc: "Published Legal Metrology regulatory updates, ministerial gazette notifications, and advisory standards for field officers.",
    modalEditRuleTitle: "Edit Statutory Rule & Legal Parameter",
    lblRuleCode: "Rule / Section Code:",
    lblStatute: "Governing Statute / Act:",
    lblRuleTitle: "Rule Title:",
    lblDescription: "Legal Requirement Description:",
    lblPenalty: "Prescribed Section Penalty / Compounding:",
    lblGazetteRef: "Gazette Notification Reference:",
    lblIsActive: "Rule Enforcement Status:",
    optActive: "Active & Enforced",
    optInactive: "Suspended / Advisory Only",
    btnSaveRule: "Save Statutory Rule",
    modalPublishAmdTitle: "Publish Official Gazette Notification",
    lblNotifNo: "Gazette Notification / Circular No:",
    lblGazetteDate: "Notification Date:",
    lblAmdTitle: "Notification Title:",
    lblAmdSummary: "Summary of Regulatory Update:",
    lblAuthority: "Issuing Authority:",
    btnPublish: "Publish Gazette Circular",

    // Admin Authentication Portal
    adminLoginTitle: "Officer Authentication Portal",
    adminLoginDesc: "Restricted enforcement terminal. Authorized Legal Metrology Officers & State Controllers only.",
    lblAdminEmail: "Official Officer Email:",
    lblAdminPassword: "Security Passcode:",
    demoCredsLabel: "Presentation Sample Credentials",
    btnAutofill: "⚡ Fill Demo Credentials",
    btnSignInConsole: "Sign In to Compliance Console",
    btnLogout: "Sign Out",
  ...
  hi: {
    ...
    // AI Assistant Chatbot
    assistantBotTitle: "मेट्रासेतु निरीक्षक AI सहायक",
    assistantBotSubtitle: "कॉमरेड AI • विधिक मापविज्ञान प्रश्नोत्तर",
    assistantBotTooltip: "AI सहायक से पूछें",
    assistantBotOpenTab: "नई विंडो में खोलें",
    assistantBotClose: "सहायक बंद करें",

    // Admin & Compliance Panel
    adminPageTitle: "मेट्रासेतु — व्यवस्थापक एवं विधिक अनुपालन पैनल",
    navAdminPanel: "व्यवस्थापक अनुपालन पैनल",
    adminStatutoryNotice: "विधिक मापविज्ञान अधिनियम, 2009 के तहत प्रवर्तन रिकॉर्ड, उल्लंघन वृद्धि लॉग, और वैधानिक कानूनी विन्यास।",
    adminHeaderTitle: "वैधानिक प्रवर्तन एवं अनुपालन प्रबंधक",
    adminHeaderSubtitle: "उठाए गए वैधानिक उल्लंघनों की निगरानी करें, शासी विधिक मापविज्ञान नियमों को अद्यतन करें, और आधिकारिक राजपत्र परिपत्र जारी करें।",
    btnAddRule: "नया वैधानिक नियम जोड़ें",
    btnPublishCircular: "राजपत्र परिपत्र जारी करें",
    adminKpiViolations: "उठाए गए उल्लंघन",
    adminKpiViolationsHint: "असंगत एवं ध्वजांकित पैकेज",
    adminKpiPending: "कार्रवाई लंबित",
    adminKpiPendingHint: "अधिकारी नोटिस / वृद्धि की प्रतीक्षा में",
    adminKpiRules: "सक्रिय वैधानिक नियम",
    adminKpiRulesHint: "कॉन्फ़िगर किए गए मानक",
    tabViolationsTitle: "उल्लंघन रजिस्ट्री",
    tabRulesTitle: "वैधानिक नियम एवं कानून प्रबंधक",
    tabAmendmentsTitle: "राजपत्र परिपत्र एवं कानून अपडेट",
    searchViolationsPlaceholder: "स्कैन आईडी, उल्लंघन प्रकार या नियम द्वारा खोजें...",
    filterAll: "सभी",
    filterPending: "समीक्षा लंबित",
    filterDraftNotice: "नोटिस प्रारूपित",
    filterEscalated: "अधिकारी को अग्रेषित",
    filterResolved: "निस्तारित / शमित",
    colScanId: "स्कैन संदर्भ आईडी",
    colTimestamp: "समय",
    colViolation: "वैधानिक उल्लंघन प्रकार",
    colSeverity: "गंभीरता",
    colSection: "शासी धारा",
    colActionStatus: "प्रवर्तन स्थिति",
    colActions: "कार्रवाई",
    loadingViolations: "उल्लंघन रजिस्ट्री लोड हो रही है...",
    rulesManagerDesc: "पैकेज स्क्रीनिंग के दौरान मूल्यांकित वैधानिक कानूनी मानकों, दंड श्रेणियों और नियम विवरणों को कॉन्फ़िगर करें।",
    amendmentsFeedTitle: "आधिकारिक राजपत्र संशोधन एवं परिपत्र फ़ीड",
    amendmentsFeedDesc: "क्षेत्रीय अधिकारियों के लिए प्रकाशित विधिक मापविज्ञान नियामक अपडेट और सलाह मानक।",
    modalEditRuleTitle: "वैधानिक नियम एवं कानूनी पैरामीटर संपादित करें",
    lblRuleCode: "नियम / धारा कोड:",
    lblStatute: "शासी अधिनियम / नियम:",
    lblRuleTitle: "नियम का नाम:",
    lblDescription: "कानूनी आवश्यकता विवरण:",
    lblPenalty: "निर्धारित धारा दंड / शमन:",
    lblGazetteRef: "राजपत्र अधिसूचना संदर्भ:",
    lblIsActive: "नियम प्रवर्तन स्थिति:",
    optActive: "सक्रिय एवं लागू",
    optInactive: "निलंबित / केवल सलाह",
    btnSaveRule: "वैधानिक नियम सहेजें",
    modalPublishAmdTitle: "आधिकारिक राजपत्र अधिसूचना प्रकाशित करें",
    lblNotifNo: "अधिसूचना / परिपत्र संख्या:",
    lblGazetteDate: "अधिसूचना तिथि:",
    lblAmdTitle: "अधिसूचना शीर्षक:",
    lblAmdSummary: "नियामक अपडेट का सारांश:",
    lblAuthority: "जारीकर्ता प्राधिकरण:",
    btnPublish: "राजपत्र परिपत्र जारी करें",

    // Admin Authentication Portal
    adminLoginTitle: "अधिकारी प्रमाणीकरण पोर्टल",
    adminLoginDesc: "प्रतिबंधित प्रवर्तन टर्मिनल। केवल अधिकृत विधिक मापविज्ञान अधिकारी एवं राज्य नियंत्रक।",
    lblAdminEmail: "आधिकारिक अधिकारी ईमेल:",
    lblAdminPassword: "सुरक्षा पासकोड:",
    demoCredsLabel: "प्रस्तुति नमूना क्रेडेंशियल",
    btnAutofill: "⚡ डेमो क्रेडेंशियल भरें",
    btnSignInConsole: "अनुपालन कंसोल में प्रवेश करें",
    btnLogout: "साइन आउट",
